...
Session::Session(QObject *parent)
    ...
    , m_asyncIOThreads(BITTORRENT_SESSION_KEY("AsyncIOThreadsCount"), 16)
    , m_hashingThreads(BITTORRENT_SESSION_KEY("HashingThreadsCount"), 2)
    , m_filePoolSize(BITTORRENT_SESSION_KEY("FilePoolSize"), 5000)
    , m_checkingMemUsage(BITTORRENT_SESSION_KEY("CheckingMemUsageSize"), 2048)
    , m_diskCacheSize(BITTORRENT_SESSION_KEY("DiskCacheSize"), 16384)
    ...
    , m_ignoreSlowTorrentsForQueueing(BITTORRENT_SESSION_KEY("IgnoreSlowTorrentsForQueueing"), true)
    ...
    , m_isPreallocationEnabled(BITTORRENT_SESSION_KEY("Preallocation"), true)
